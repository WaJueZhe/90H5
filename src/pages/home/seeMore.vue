    ...
    <scroller
      ...
      <div class="deal-group">
        <div class="deal-item"  v-for="(item,index) in list" :key="index">
          ...
          <div class="deal-haxi">{{item.transHash}}</div>
          <div class="deal-type">{{ $t('seeMore.seeMore2') }}{{[item.transType,$i18n.locale]|transTypeToName}}</div>
          <div class="deal-money">
            <div class="deal-money-l">
              <span>{{ $t('seeMore.seeMore3') }}</span>
